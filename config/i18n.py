...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "choose_password_placeholder": "选择密码（至少10位，避免常见弱密码）",
        "confirm_password_placeholder": "确认密码",
        "email_optional": "邮箱（必填）",
        "email_required_help": "邮箱是必填项：用于密码找回、账户通知和必要的用户联系。",
        "email_required_placeholder": "用于密码找回和账户联系",
        "email_required_error": "请填写邮箱。邮箱用于密码找回和账户联系。",
        "email_invalid_error": "请填写有效的邮箱地址。",
        ...
        "email_not_set": "未设置邮箱",
        "account_email": "📮 账户邮箱",
        "account_email_help": "用于登录找回、邮箱验证、套餐升级和系统通知。更换后需要重新验证新邮箱。",
        "account_email_input": "账户邮箱",
        "save_account_email": "保存账户邮箱",
        "account_email_required": "请输入有效邮箱",
        "account_email_updated": "账户邮箱已更新，请完成新邮箱验证。",
        "account_email_unchanged": "账户邮箱未变化",
        "account_email_update_failed": "邮箱更新失败",
        "upgrade_plan": "🚀 升级套餐",
        ...
        "new_password_placeholder": "请输入新密码（至少10位，避免常见弱密码）",
    ...
    "en": {
        ...
        "choose_password_placeholder": "Choose a password (10+ chars, avoid common weak passwords)",
        "confirm_password_placeholder": "Confirm your password",
        "email_optional": "Email (required)",
        "email_required_help": "Email is required for password recovery, account notices, and essential account contact.",
        "email_required_placeholder": "Used for password recovery and account contact",
        "email_required_error": "Please enter an email. It is used for password recovery and account contact.",
        ...
        "account_email_help": "Used for account recovery, email verification, plan upgrades, and system notifications. Changing it requires verifying the new address.",
        "account_email_input": "Account email",
        "save_account_email": "Save account email",
        "account_email_required": "Please enter a valid email",
        "account_email_updated": "Account email updated. Please verify the new address.",
        "account_email_unchanged": "Account email unchanged",
        "account_email_update_failed": "Email update failed",
        ...
        "new_password_placeholder": "Enter new password (10+ chars, avoid common weak passwords)",
